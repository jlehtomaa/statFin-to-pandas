...
def getData(dataDict, baseYear = None, filters =None, search = False, outputfolder = None):
    ...
    for i in dataDict:
        ...
        # Store the raw data in csv format into working directory or a specified folder:
